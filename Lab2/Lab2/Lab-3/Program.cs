        ...
        {
            {
                ...
                Console.WriteLine("shifted a-mantisa: " + new string('0', 32 - Convert.ToString(b_mantisa, 2).Length) + Convert.ToString(b_mantisa, 2));
                ...
                //significants
                Console.WriteLine("Step2: add significants: " +
